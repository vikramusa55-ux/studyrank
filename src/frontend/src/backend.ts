...
import type { TaskUpdateAction as _TaskUpdateAction, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async dailyTaskReset(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.dailyTaskReset();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyProfile(): Promise<PublicUserProfile> {
        if (this.processError) {
            try {
    ...
    async getPublicUserProfile(arg0: Principal): Promise<PublicUserProfile> {
        if (this.processError) {
            try {
    ...
    async logStudySession(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logStudySession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTask(arg0: string, arg1: TaskUpdateAction): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTask(arg0, to_candid_TaskUpdateAction_n5(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_TaskUpdateAction_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TaskUpdateAction): _TaskUpdateAction {
...
function to_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TaskUpdateAction): {
    delete: null;
} | {
    complete: null;
} {
    return value == TaskUpdateAction.delete ? {
        delete_: null
    } : value == TaskUpdateAction.complete ? {
        complete: null
    } : value;
}
